...
lexicon_word = open("data/lexicon_word_lp.txt", "w")
lexicon_label = open("data/lexicon_label_lp.txt", "w")

training_set = open("data/training_set_lp", "w")
validation_set = open("data/validation_set_lp", "w")
testing_set = open("data/testing_set_lp", "w")
